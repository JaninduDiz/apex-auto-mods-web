...
export function CarModel({ customization, ...props }: CarModelProps) {
  const { nodes, materials } = useGLTF("/mclaren720.gltf") as any;

  return (
    <group {...(props as any)} dispose={null}>
      <group rotation={[-Math.PI / 2, 0, 0]} scale={1.149}>
        {/* --- BASE CAR AND STATIC PARTS --- */}
        {/* These parts are always visible */}
        <mesh
        ...
        <mesh
          ...
          material={materials.Grille4_Material}
        />
        <mesh
        ...
        <mesh
          ...
          material={materials.InteriorTilling_Material}
        />
        <mesh
          geometry={nodes.Object_12.geometry}
          material={materials.Grille5_Material}
        />
        <mesh
          geometry={nodes.Object_13.geometry}
          material={materials.Grille6_Material}
        />
        <mesh
          geometry={nodes.Object_14.geometry}
          material={materials.NumberPlate_Material}
        />
        <mesh
        ...
        <mesh
          ...
          material={materials.Paint_Material}
          material-color={customization.color}
        />
        <mesh
        ...
        {/* Spoiler */}
        <group visible={customization.selectedParts.includes("spoiler")}>
          <mesh
        ...
        <group visible={customization.selectedParts.includes("bodykit")}>
          <mesh
        ...
        {/* Custom Wheel */}
        <group visible={customization.selectedParts.includes("wheels")}>
          <mesh
            geometry={nodes.Object_37.geometry}
            material={materials.bespoke}
            material-color={customization.wheelColor}
          />
          <mesh

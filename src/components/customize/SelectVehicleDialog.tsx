...
import { type UserVehicle } from '@/lib/constants';
...
export function SelectVehicleDialog({ isOpen, setIsOpen, vehicles, isLoading }: SelectVehicleDialogProps) {
    ...
    const handleContinue = () => {
        if (selectedValue) {
            ...
            if (selectedVehicle) {
                const carModel = encodeURIComponent(`${selectedVehicle.make} ${selectedVehicle.carModel}`);
                            ...
                            <div className="space-y-2">
                                {vehicles.map(vehicle => (
                                    ...
                                    >
                                        ...
                                        <span className="font-semibold">{vehicle.make} {vehicle.carModel}</span>
                                    </Label>
                                ))}
                            </div>
                        </RadioGroup>
